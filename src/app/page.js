          ...
          <div className="grid w-[90%] grid-flow-row grid-cols-1 gap-5 justify-self-center lg:grid-cols-2">
            ...
            <div className="align-center flex w-full flex-col justify-center gap-6 justify-self-center p-3 text-center lg:text-left">
              ...
              <p className="text-xl">
                ...
                simplicity, using smooth animations and a streamlined color
                scheme to enhance user experience. Key metrics and progress
                tracking are presented in a visually appealing, easy-to-read
                format.{" "}
              </p>
            </div>
            ...
            <div className="align-center flex w-full flex-col justify-center gap-6 p-3 text-center lg:text-left">
              ...
              <p className="text-xl">
                ...
                displaying all your time standards in one place. Easily track
                your best events, compare progress, and see where you stand
                across different levels. With clear insights, you can focus on
                what matters most—improving your swim times.
              </p>
            </div>
          </div>
